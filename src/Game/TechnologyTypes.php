    ...
    private static array $technologies = [
        'shared' => [
            'energy_tech' => [
                ...
                'base_cost' => ['metal' => 1000, 'crystal' => 500, 'deuterium' => 0],
                'base_time' => 600,
                'prerequisites' => [],
                'effects' => [],
            ],
        ...
        'unsc' => [
            'industrial_mastery' => [
                ...
                'base_cost' => ['metal' => 1200, 'crystal' => 600, 'deuterium' => 0],
                'base_time' => 600,
            ...
            'propulsion_tech' => [
                ...
                'base_cost' => ['metal' => 6000, 'crystal' => 1200, 'deuterium' => 6000],
                'base_time' => 1800,
            ...
            'electronics_tech' => [
                ...
                'base_cost' => ['metal' => 10000, 'crystal' => 6000, 'deuterium' => 2000],
                'base_time' => 4200,
                'prerequisites' => ['energy_tech'],
            ...
            'robotics_tech' => [
                ...
                'base_cost' => ['metal' => 180000, 'crystal' => 120000, 'deuterium' => 60000],
                'base_time' => 72000,
            ...
            'ai_computer' => [
                ...
                'base_cost' => ['metal' => 40000, 'crystal' => 160000, 'deuterium' => 80000],
                'base_time' => 72000,
            ...
            'weapons_tech' => [
                ...
                'base_cost' => ['metal' => 8000, 'crystal' => 2000, 'deuterium' => 4000],
                'base_time' => 3600,
            ...
            'shield_gen_tech' => [
                ...
                'base_cost' => ['metal' => 6000, 'crystal' => 2000, 'deuterium' => 6000],
                'base_time' => 3000,
                'prerequisites' => ['energy_tech'],
            ...
            'armor_tech' => [
                ...
                'base_cost' => ['metal' => 10000, 'crystal' => 10000, 'deuterium' => 0],
                'base_time' => 3600,
                'prerequisites' => ['industrial_mastery'],
            ...
            'research_bonus' => [
                ...
                'base_cost' => ['metal' => 20000, 'crystal' => 40000, 'deuterium' => 20000],
                'base_time' => 7200,
                'prerequisites' => ['energy_tech'],
            ...
            'observation_tech' => [
                ...
                'base_cost' => ['metal' => 400000, 'crystal' => 200000, 'deuterium' => 0],
                'base_time' => 14400,
            ...
            'hyperdrive_tech' => [
                ...
                'base_cost' => ['metal' => 200000, 'crystal' => 100000, 'deuterium' => 200000],
                'base_time' => 14400,
    ...
    private static array $ships = [
        'unsc' => [
            ...
            'hornet' => [
                ...
                'base_cost' => ['metal' => 2000, 'crystal' => 0, 'deuterium' => 2000],
                'build_time' => 300,
            ...
            'small_transporter' => [
                ...
                'base_cost' => ['metal' => 3000, 'crystal' => 1000, 'deuterium' => 3000],
                'build_time' => 300,
                'required_tech' => 'industrial_mastery',
            ...
            'pelican' => [
                ...
                'base_cost' => ['metal' => 5500, 'crystal' => 3000, 'deuterium' => 3000],
                'build_time' => 900,
            ...
            'corvette' => [
                ...
                'base_cost' => ['metal' => 2000, 'crystal' => 1000, 'deuterium' => 0],
                'build_time' => 300,
                'required_tech' => 'industrial_mastery',
            ...
            'light_corvette' => [
                ...
                'base_cost' => ['metal' => 48000, 'crystal' => 52000, 'deuterium' => 0],
                'build_time' => 1800,
            ...
            'marathon_class' => [
                ...
                'base_cost' => ['metal' => 20000, 'crystal' => 7000, 'deuterium' => 20000],
                'build_time' => 3600,
            ...
            'osiris_class' => [
                ...
                'base_cost' => ['metal' => 45000, 'crystal' => 15000, 'deuterium' => 15000],
                'build_time' => 3600,
                'required_tech' => 'shield_gen_tech',
            ...
            'arrowhead' => [
                ...
                'base_cost' => ['metal' => 500000, 'crystal' => 250000, 'deuterium' => 250000],
                'build_time' => 36000,
            ...
            'prowler' => [
                ...
                'base_cost' => ['metal' => 3000, 'crystal' => 3000, 'deuterium' => 6000],
                'build_time' => 600,
            ...
            'longsword' => [
                ...
                'base_cost' => ['metal' => 60000, 'crystal' => 60000, 'deuterium' => 60000],
                'build_time' => 14400,
                'required_tech' => 'hyperdrive_tech',
            ...
            'pillar_of_autumn' => [
                ...
                'base_cost' => ['metal' => 750000, 'crystal' => 400000, 'deuterium' => 350000],
                'build_time' => 18000,
                'required_tech' => 'ai_computer',
            ...
            'halcyon_cruiser' => [
                ...
                'base_cost' => ['metal' => 35000, 'crystal' => 12000, 'deuterium' => 25000],
                'build_time' => 3000,
                'required_tech' => 'shield_gen_tech',
            ...
            'heavy_marine' => [
                ...
                'base_cost' => ['metal' => 8000, 'crystal' => 4000, 'deuterium' => 0],
                'build_time' => 450,
                'required_tech' => 'weapons_tech',
        ...
        'covenant' => [
            ...
            'prowler' => [
                ...
                'base_cost' => ['metal' => 4000, 'crystal' => 4000, 'deuterium' => 8000],
                'build_time' => 600,
